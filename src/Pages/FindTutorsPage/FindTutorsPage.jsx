            ...
            <div className="container py-10">
                ...
                <div className="flex justify-between mb-10 gap-5 md:gap-10 lg:gap-20 flex-col md:flex-row">
                    <div className='w-full md:w-4/12'>
                        ...
                        <input onChange={handleSearchTutor} type="serach" className='input input-bordered w-full mx-auto text-black bg-white dark:bg-darklight border border-white' placeholder='Search Tutor...' />
                    </div>
                    <div className='w-full md:w-4/12'>
                        <label className='label font-bold'>Sort By Language:</label>
                        <select onChange={handleSortChange} className='select select-bordered w-full bg-white dark:bg-darklight border border-white'>
